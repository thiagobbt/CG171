...
void Window::zoom(double zoom) {
	double center_x = (starting_point.get_x() + end_point.get_x()) / 2;
	double center_y = (starting_point.get_y() + end_point.get_y()) / 2;

	double width = (end_point.get_x() - starting_point.get_x()) / zoom;
	double height = (end_point.get_y() - starting_point.get_y()) / zoom;
